...
LRESULT CMainFrame::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	...
	// Use initialUrl from command-line or env var, fallback to default
	std::wstring initialUrl = !m_webviewprofile.initialUrl.empty() 
		? m_webviewprofile.initialUrl 
		: L"https://msdn.microsoft.com";

	m_webview2 = std::make_unique<WebView2::Core::CWebView2>(m_webviewprofile.browserDirectory, m_webviewprofile.userDataDirectory, initialUrl);
	...
	UISetCheck(ID_SCENARIO_WININET_PRECERT, 1); // enabled by default
...
LRESULT CMainFrame::OnScenarioInstallation(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	...
	std::wstring version = WebView2::Utilities::Utility::GetWebView2Version();
	...
	std::wstring path;
	HRESULT hr = WebView2::Utilities::Utility::DownloadWebView2Bootstrapper(path);
	...
	hr = WebView2::Utilities::Utility::InstallWebView2(path, /*elevated*/ false);
...
LRESULT CMainFrame::OnScenarioCertificateCustomDlg(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	...
	// Update the checkmark using the WTL CUpdateUI mechanism
...
LRESULT CMainFrame::OnScenarioWininetPreCert(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	...
	{
		// Disable and clear the stored certificate
